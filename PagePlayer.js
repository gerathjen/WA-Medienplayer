/*
PagePlayer v 0.5.6
 copyright 2012 jezra j lickter
licensed GPL3
...
var project_page='http://www.jezra.net/projects/pageplayer';
...
function PagePlayer( list )
{
	...
	if(ulist==null)
	{
		...
		credit.setAttribute("id","PagePlayerCredit");
		wrapper.appendChild(credit);
		credit.innerHTML="Created using <a href='"+project_page+"'>PagePlayer</a>";
